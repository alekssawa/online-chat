...
export interface User {
	...
	publicKey?: string // PEM/base64 string
	encryptedPrivateKey?: string // base64 AES-GCM payload
	salt?: string // base64
	iv?: string // base64
	kdfIterations?: number

	keyCreatedAt: string // ISO date string
	keyUpdatedAt: string // ISO date string
}
